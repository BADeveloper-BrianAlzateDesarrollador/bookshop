<?php 
	...
	{	
		...
		public function init($num,$num2)
		{
			...
			$this->info = $this->name ."<br>". $this->email . "<br>" . $this->role . "<br> suma: " .$this->suma ."<br> resta: " . $this->resta ."<br> división: " . $this->division .  "<br> los numeros son: " . $this->num1 . " y " . $this->num2;
